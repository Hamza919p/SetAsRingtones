...
import com.wmt.setasringtones.databinding.FragmentLatestChannelTonesBinding
import com.wmt.setasringtones.viewModels.fragments.channelDetails.ChannelLatestAndBestTonesViewModel
import kotlinx.coroutines.flow.collectLatest

class ChannelLatestTonesFragment : Fragment() {
    private lateinit var binding: FragmentLatestChannelTonesBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_latest_channel_tones, container, false)
    ...
    private fun initializeViewModel() {
        ...
        binding.apply {
            latestChannelTones = viewModel
            lifecycleOwner = this@ChannelLatestTonesFragment
        }
    }
    ...
    private fun initializeAdapter() {
        ...
        binding.rvChannelLatestTones.apply {
        ...
        tonesAdapter.addLoadStateListener { loadState ->
            if(loadState.source.refresh is LoadState.NotLoading){
                if(tonesAdapter.itemCount < 1){
                    ...
                    binding.rvChannelLatestTones.visibility = View.GONE
                }else{
                    binding.tvEmpty.visibility = View.GONE
                    binding.rvChannelLatestTones.visibility = View.VISIBLE
                }
            }
        }
    ...
    private fun updateTonesAdapter() {
        ...
        lifecycleScope.launchWhenCreated {
            viewModel.getTones(binding.swipeRefresh, parentActivity?.userId!!, true).collectLatest {
