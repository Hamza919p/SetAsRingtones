...
import com.wmt.setasringtones.databinding.FragmentFeaturedTonesBinding
import com.wmt.setasringtones.viewModels.fragments.home.HomeFragmentsViewModel
import kotlinx.coroutines.flow.collectLatest


class FeaturedTonesFragment : Fragment() {
    private lateinit var binding: FragmentFeaturedTonesBinding
    ...
    override fun onCreateView(
        ...
        binding =
            DataBindingUtil.inflate(inflater, R.layout.fragment_featured_tones, container, false)
        return binding.root
    }
    ...
    private fun initializeViewModel() {
        ...
        binding.apply {
            featuredTones = viewModel
            lifecycleOwner = this@FeaturedTonesFragment
        }
    }
        ...
        tonesAdapter.addLoadStateListener { loadState ->
            if(loadState.source.refresh is LoadState.NotLoading){
                if(tonesAdapter.itemCount < 1){
                    ...
                    binding.rvFeaturedTones.visibility = View.GONE
                }else{
                    binding.tvEmpty.visibility = View.GONE
                    binding.rvFeaturedTones.visibility = View.VISIBLE
                }
            }
        }
    ...
    private fun updateTonesAdapter() {
        ...
        lifecycleScope.launchWhenCreated {
            viewModel.getTones(binding.swipeRefresh, "Featured").collectLatest {
