...
class FeaturedTonesPagingSource(private val apiServices: ApiServices, private var swipeRefreshLayout: SwipeRefreshLayout) :
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, TonesItem> {
        return try {
            ...
            val response = apiServices.getFeaturedTonesResponse(currentPageNumber.toString())
